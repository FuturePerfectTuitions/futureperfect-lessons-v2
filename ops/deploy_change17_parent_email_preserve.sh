...
test "$WORKER_ENTRYPOINT" = 'src/index-phase23-protected-view-stability.js'
...
grep -Fq 'main = "src/index-phase23-protected-view-stability.js"' worker/wrangler.change17.runtime.toml
...
if [[ "$PARENT_EMAIL_LIVE" == "1" ]]; then
  echo 'PARENT_EMAIL_DEPLOYED_LIVE_ON_PHASE23_WRAPPER'
else
  echo 'PARENT_EMAIL_DEPLOYED_IN_TEST_MODE_ON_PHASE23_WRAPPER'
fi
