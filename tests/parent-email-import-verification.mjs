...
assert.equal(SIGNATURE_URL, 'https://futureperfecttuitions.github.io/futureperfect-lessons-v2/assets/sej-email-signature.jpg');
...
assert.match(payload.html, /https:\/\/futureperfecttuitions\.github\.io\/futureperfect-lessons-v2\/assets\/sej-email-signature\.jpg/);
