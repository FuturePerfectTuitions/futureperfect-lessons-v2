...
// Final lesson status is authoritative. Progress remarks can remain as history,
// but cannot turn a lesson completed in this session back into an Ongoing email.
...
assert.equal(ongoingSlideText(aaravCompleted), 'Slide 10');
